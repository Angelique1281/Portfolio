...
<head>
  ...
  <title>Corsica Games Week</title>
  <link href="https://fonts.googleapis.com/css2?family=Holtwood+One+SC&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="style.css">
</head>
<body class="page-photoshop2">
     <!-- Navbar -->
  <div class="navbar">
    <ul class="menu">
